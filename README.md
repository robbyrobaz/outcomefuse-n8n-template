# OutcomeFuse n8n Loss Circuit Breaker

An importable n8n HTTP Request node for reporting a business outcome to [OutcomeFuse](https://web-production-b0715.up.railway.app).

n8n can report a successful execution even when the workflow produced an empty, stale, incomplete, or commercially harmful result. OutcomeFuse is an independent watcher for n8n agencies: it checks expected outcomes and cadence, records incident evidence, enforces rolling 24-hour and 7-day loss budgets, and can deactivate only an explicitly armed workflow through the official n8n API.

## Install

1. [Start a 14-day OutcomeFuse trial](https://web-production-b0715.up.railway.app/signup).
2. Connect an n8n instance and create an outcome contract.
3. Download or copy `outcomefuse-outcome-signal.json` into n8n.
